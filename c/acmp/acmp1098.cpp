...
// screw the optimization using nasty hardcoding hack
...
inline int place(Brd &brd, int r, int kq, int kr) {
    int cnt = 0;
    if (kq == 0 && kr == 0) {
        cnt++;
    } else {
